...
export async function getSwimmingPoolDetailById(
  ...
  const querySwimmingPoolDetail = groq`*[_type == "swimmingPoolDetail" && categoryId == $categoryId && swimmingPool->slug.current == $swimmingPoolId][0]{"id":_id,skillRequirement,announcements,sampleTraining,imageGallery,fileUploads,faq}`;
