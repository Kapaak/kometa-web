...
export const HeadSelector = () => {
  ...
  return (
    <Head>
      ...
      <link rel="canonical" href="https://www.kometa-web.vercel.app" />
      ...
      <meta property="og:url" content="https://www.kometa-web.vercel.app" />
      ...
      <meta
        ...
        content="https://www.kometa-web.vercel.app"
      />
