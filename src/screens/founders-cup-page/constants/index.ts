...
export const CONTEST_TIME_TABLE_PART1: ContestTimeTable[] = [
  ...
  { id: 4, title: '50 m polohový závod', group: 'žáci B' },
...
export const CONTEST_TIME_TABLE_PART2: ContestTimeTable[] = [
  ...
  { id: 23, title: '100 m polohový závod', group: 'žačky A' },
  { id: 24, title: '100 m polohový závod', group: 'žáci A' },
  { id: 25, title: '100 m motýlek', group: 'žačky B' },
  { id: 26, title: '100 m motýlek', group: 'žáci B' },
